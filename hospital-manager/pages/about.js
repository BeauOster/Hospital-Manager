      ...
      <div className="aboutMain">
        ...
        <div className="introParagraph">
          ...
          <p>This system is designed to help staff members add and organize important information
            ...
            prescription handlings, and record collection in order to foster a more organized work environment
            for hospital staff members. The system's integrated software improves the clincal workflow and makes 
        ...
        <div className="experienceParagraph"> 
            ...
            <p className="experienceFont">Rest Assured Hospital Management aims to create an environment that fosters
              ...
              provide real-time updates, and make for more personable visits. All of which lead
        ...
        <div className="workloadParagraph">
          ...
          <p className="workloadFont">By developing a system that streamlines workflow, this management system
            ...
            medication errors, and mistakes with billing. Ultimately, this increased level
            of effciency gives staff the opportunity to focus more on caring for their patients.
          </p>
        </div>
        ...
        <div className="managementParagraph">
          ...
          access this information also allows health care providers to make quick and 
          well-informed decisions. Any errors that may occur along the way can lead to 
          ...
          the hospital. There is also the system's legal components. All hospitals must
          make all legal requirements, which is why properly managing this data 
          simplifies this process. This data can then be used for analytical purposes in 
          terms of medical studies such as health studies and hospital performance. Even 
          though those things are of great importance, the Rest Assured Hospital Management
          system prides itself on patient privacy and data security. Having authentification
          protocols set in place is what helps the system make sure that sensitive is never
